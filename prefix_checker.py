...
class PDFAnalyzerGUI:
    ...
    def analyze_pdf_files(self, directory_path, recursive=True):
        ...
        for folder, found_prefixes in folder_prefixes.items():
            ...
            # Check for ID requirement (any of the ID variations)
    ...
    def generate_summary(self, results):
        ...
        summary += f"• Files missing TT-BC in path: {tt_issues}\n"
        summary += f"• Folders with missing prefixes: {missing_folders}\n\n"
    ...
    def generate_issues_info(self, results):
        ...
        if results['files_without_tt']:
            issues += "FILES NOT FOLLOWING TT-BC PATTERN\n"
            issues += "=" * 50 + "\n"
            issues += "Expected: TT-BC should appear somewhere in the file path\n\n"
